...
namespace PricePredictionML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\_Repo\ml-net-model-builder\PricePrediction\taxi-fare-train.csv";
        private static string MODEL_FILEPATH = @"../../../../PricePredictionML.Model/MLModel.zip";
