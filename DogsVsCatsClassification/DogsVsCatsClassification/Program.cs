...
namespace DogsVsCatsClassification
{
    class Program
    {
        ...
        static readonly string _predictSingleImage = Path.Combine(_assetsPath, "inputs-predict-single", "data", "bunny.jpg");
        ...
        {            
            var imageDataView = mlContext.Data.LoadFromEnumerable(ReadFromTsv(dataLocation, imagesFolder));
